...
app.get('/api/PeriodicElement', async (req, res) => {
    try {
        ...
        const result = await sql.query`SELECT * FROM PeriodicElement`;
...
app.post('/api/PeriodicElement', async (req, res) => {
    ...
    try {
        ...
        const result = await sql.query`INSERT INTO PeriodicElement (nome, email) VALUES (${nome}, ${email})`;
...
app.put('/api/PeriodicElement/:id', async (req, res) => {
    ...
    try {
        ...
        const result = await sql.query`UPDATE PeriodicElement SET nome = ${nome}, email = ${email} WHERE id = ${id}`;
